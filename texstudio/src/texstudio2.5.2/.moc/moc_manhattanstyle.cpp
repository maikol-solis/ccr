...
const QMetaObjectExtraData ManhattanStyle::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ManhattanStyle::staticMetaObject = {
    { &QWindowsStyle::staticMetaObject, qt_meta_stringdata_ManhattanStyle,
      qt_meta_data_ManhattanStyle, &staticMetaObjectExtraData }
};
